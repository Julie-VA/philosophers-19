...
/*   Updated: 2021/10/22 16:12:53 by rvan-aud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	set_args(int argc, char **argv, t_args *args)
{
	...
	if (isnumber(argv[2]))
		args->t_die = ft_atoi(argv[2]) * 1000;
	if (isnumber(argv[3]))
		args->t_eat = ft_atoi(argv[3]) * 1000;
	if (isnumber(argv[4]))
		args->t_sleep = ft_atoi(argv[4]) * 1000;
	...
	if (args->phi_count <= 0 || args->t_die < 0 || args->t_eat < 0
		...
		|| args->phi_count > 200 || args->t_die < 60000 || args->t_eat < 60000
		|| args->t_sleep < 60000)
	{
